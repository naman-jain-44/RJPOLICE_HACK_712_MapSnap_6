...
public final class CameraXLivePreviewActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    dataAdapter = new ArrayAdapter<>(this, R.layout.spinner_style, options);
    ...
    // Start the delayed switching of Spinner items
...
//    try {
//      // Your code or tasks to be executed go here
//      System.out.println("Executing tasks...");
//      selectedModel = TEXT_RECOGNITION_LATIN;
//      bindAnalysisUseCase();
//      // Wait for 5 seconds (5000 milliseconds)
//      Thread.sleep(5000);
//      selectedModel =  IMAGE_LABELING;
//      bindAnalysisUseCase();
//      Thread.sleep(5000);
//
...
//    }
  ...
  private void startSwitching() {
    handler.postDelayed(new Runnable() {
      @Override
      public void run() {
        // Switch to the next item in the Spinner
        currentPosition = (currentPosition + 1) % dataAdapter.getCount();
        spinner.setSelection(currentPosition);
        handler.postDelayed(this, 5000); // Switch every 5 seconds
      }
    }, 5000); // Initial delay before the first switch
  }
